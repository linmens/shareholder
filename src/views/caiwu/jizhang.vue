        ...
        <Row class="toolbar">
            ...
            <Col span="4">
              <span style="color:#657180">收入</span>
                 <div class="income" style="font-size:30px"><Icon type="plus"></Icon> <span >{{jsonBody.income_all}}</span></div>
            </Col>
              <Col span="4">
...
<Row type="flex" justify="start" class="code-row-bg"  >
        ...
        <img src="https://striker.teambition.net/thumbnail/110c368fba8ff41a064151f70ca78c81e561/w/200/h/200" class="avatar img-circle" width="24">
...
<script>
    ...
    export default {
        data() {
            return {
                jsonBody:[],
                menuitem:[{text:'购买设备'},{text:'宽带费'},{text:'备用金'}],
        ...
        methods: {
            ...
            addNewmenu(){
                var newItem = {text:this.pushNewmenu}
...
.entry-creator-modal-view .entry-category .expense li.active .entry-icon, .entry-creator-modal-view .entry-category .expense li:hover .entry-icon {
    background-color: #ff9900;
    border-color: #ff9900;
}
.entry-creator-modal-view .entry-category li.active .entry-icon, .entry-creator-modal-view .entry-category li:hover .entry-icon {
    color: #FFFFFF;
}
...
.entry-creator-modal-view .entry-category li.active .entry-category-title, .entry-creator-modal-view .entry-category li:hover .entry-category-title {
    color: #383838;
}
...
.entry-creator-modal-view .entry-tags-set, .entry-creator-modal-view .entry-involve-set {
 ...
 .add-involvement-handler li > a > .avatar, .add-involvement-handler li > a > .icon {
    width: 24px;
    height: 24px;
    float: left;
    margin-left: -2px;
